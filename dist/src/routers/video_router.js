...
videoRoutes.post("/", video_multer_js_1.default.single("url"), video_controller_js_1.default.postVideo);
videoRoutes.get("/userId", video_controller_js_1.default.getTotalVideoByUser);
